"use strict";
(self["webpackChunkwind_es"] = self["webpackChunkwind_es"] || []).push([["vendors-node_modules_arcgis_core_views_2d_engine_FeatureContainer_js-node_modules_arcgis_core-935e5f"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AttributeStoreView": () => (/* binding */ k)
/* harmony export */ });
...
/* harmony import */ var _Utils_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Utils.js */ "./node_modules/@arcgis/core/views/2d/engine/webgl/Utils.js");
/* harmony import */ var _util_debug_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./util/debug.js */ "./node_modules/@arcgis/core/views/2d/engine/webgl/util/debug.js");
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
const z=_core_Logger_js__WEBPACK_IMPORTED_MODULE_2__.default.getLogger("esri.views.2d.engine.webgl.AttributeStoreView"),U=(0,_util_debug_js__WEBPACK_IMPORTED_MODULE_15__.createDebugLogger)(_util_debug_js__WEBPACK_IMPORTED_MODULE_15__.DEBUG_ATTR_UPDATES,z),S=2147483647,j=t=>t&S;class D{constructor(t,e,i){this._texture=null,this._lastTexture=null,this._fbos={},this.texelSize=4;const{buffer:s,pixelType:r,textureOnly:a}=t,h=(0,_Utils_js__WEBPACK_IMPORTED_MODULE_14__.getPixelArrayCtor)(r);this.shared=i,this.pixelType=r,this.size=e,this.textureOnly=a,a||(this.data=new h((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrap)(s))),this._resetRange()}destroy(){(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.andThen)(this._texture,(t=>t.dispose()));for(const t in this._fbos)(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.andThen)(this._fbos[t],(e=>{"0"===t&&e.detachColorTexture(),e.dispose()})),this._fbos[t]=null;this._texture=null}get _textureDesc(){return{target:3553,wrapMode:33071,pixelFormat:6408,dataType:this.pixelType,samplingMode:9728,width:this.size,height:this.size}}setData(t,e,i){const s=j(t),r=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrap)(this.data),a=s*this.texelSize+e;!r||a>=r.length||(r[a]=i,this.dirtyStart=Math.min(this.dirtyStart,s),this.dirtyEnd=Math.max(this.dirtyEnd,s))}getData(t,e){if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(this.data))return null;const i=j(t)*this.texelSize+e;return!this.data||i>=this.data.length?null:this.data[i]}getTexture(t){return (0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrapOr)(this._texture,(()=>this._initTexture(t)))}getFBO(t,e=0){if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(this._fbos[e])){const i={colorTarget:0,depthStencilTarget:0},s=0===e?this.getTexture(t):this._textureDesc;this._fbos[e]=new _webgl_FramebufferObject_js__WEBPACK_IMPORTED_MODULE_6__.default(t,i,s)}return this._fbos[e]}get locked(){return!(5121!==this.pixelType||!this.shared||this.textureOnly||!(0,_core_has_js__WEBPACK_IMPORTED_MODULE_1__.default)("esri-atomics")||!this.data)&&1===Atomics.load(this.data,0)}get hasDirty(){const t=this.dirtyStart;return this.dirtyEnd>=t}updateTexture(e,i){if(!this.locked){try{const i=this.dirtyStart,s=this.dirtyEnd;if(!this.hasDirty)return;this._resetRange();const r=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrap)(this.data).buffer,a=this.getTexture(e),h=4,o=(i-i%this.size)/this.size,d=(s-s%this.size)/this.size,u=o,l=this.size,p=d,c=o*this.size*h,x=(l+p*this.size)*h-c,g=(0,_Utils_js__WEBPACK_IMPORTED_MODULE_14__.getPixelArrayCtor)(this.pixelType),_=new g(r,c*g.BYTES_PER_ELEMENT,x),f=this.size,b=p-u+1;if(b>this.size)return void z.error(new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__.default("mapview-webgl","Out-of-bounds index when updating AttributeData"));a.updateData(0,0,u,f,b,_)}catch(s){}i()}}update(t){const{data:e,start:i,end:s}=t;if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isSome)(e)){const s=this.data,r=i*this.texelSize;for(let i=0;i<e.length;i++){const a=1<<i%this.texelSize;t.layout&a&&(s[r+i]=e[i])}}this.dirtyStart=Math.min(this.dirtyStart,i),this.dirtyEnd=Math.max(this.dirtyEnd,s)}resize(t,e){const i=this.size;if(this.size=e,this.textureOnly)return void(i!==this.size&&(this._lastTexture=this._texture,this._texture=null));const s=(0,_Utils_js__WEBPACK_IMPORTED_MODULE_14__.getPixelArrayCtor)(this.pixelType);this.destroy(),this.data=new s((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrap)(t.buffer))}_resetRange(){this.dirtyStart=2147483647,this.dirtyEnd=0}_initTexture(t){const e=new _webgl_Texture_js__WEBPACK_IMPORTED_MODULE_11__.default(t,this._textureDesc,(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrapOr)(this.data,void 0));if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isSome)(this._lastTexture)&&this._fbos[0]){const i=this._lastTexture.descriptor.width,s=this._lastTexture.descriptor.height,r=this._lastTexture.descriptor.dataType,a=this._lastTexture.descriptor.pixelFormat,h=this.getFBO(t),n=(0,_Utils_js__WEBPACK_IMPORTED_MODULE_14__.getPixelBytes)(r),o=new((0,_Utils_js__WEBPACK_IMPORTED_MODULE_14__.getPixelArrayCtor)(r))(new ArrayBuffer(i*s*n*this.texelSize)),d=t.getBoundFramebufferObject(),{x:u,y:l,width:p,height:c}=t.getViewport();t.bindFramebuffer(h),h.readPixels(0,0,i,s,a,r,o),e.updateData(0,0,0,2*i,s/2,o),t.setViewport(u,l,p,c),t.bindFramebuffer(d)}return this.destroy(),this._texture=e,this._texture}}class k{constructor(t){this._onUpdate=t,this._initialized=!1,this._forceNextUpload=!1,this._locked=!1}initialize(t){const{blocks:e,shared:i,size:h}=t;if(this.shared=i,this.size=h,U("Initializing AttributeStoreView",t),(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(this._data))this._data=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.mapMany)(e,(t=>new D(t,h,i)));else for(let r=0;r<this._data.length;r++){const t=this._data[r],n=e[r];(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isSome)(n)&&((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(t)?this._data[r]=new D(n,h,i):t.resize(n,h))}this._initialized=!0}destroy(){(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.andThen)(this._data,(t=>(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.mapMany)(t,(t=>t.destroy())))),(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.andThen)(this._defaultTexture,(t=>t.dispose()))}isUpdating(){const t=this._data;if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(t))return!0;const i=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isSome)(this._pendingAttributeUpdate),r=i;return (0,_core_has_js__WEBPACK_IMPORTED_MODULE_1__.default)("esri-2d-log-updating")&&console.log(`Updating AttributeStoreView ${r}\n  -> hasPendingUpdate ${i}`),r}getBlock(t){if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(this._data))return null;return this._data[t]}setLabelMinZoom(t,e){this.setData(t,0,1,e)}getLabelMinZoom(t){return this.getData(t,0,1,255)}getFilterFlags(t){return this.getData(t,0,0,0)}getVVSize(t){return this.getData(t,_definitions_js__WEBPACK_IMPORTED_MODULE_13__.ATTRIBUTE_DATA_VV,0,0)}getData(t,e,i,r){if(!this._data)return 0;const h=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrap)(this._data)[e];if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(h))return 0;const o=h.getData(t,i);return (0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isSome)(o)?o:r}setData(t,e,i,s){const r=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrap)(this._data)[e];(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrap)(r).setData(t,i,s)}lockTextureUpload(){this._locked=!0}unlockTextureUpload(){this._locked=!1}forceTextureUpload(){this._forceNextUpload=!0}async requestUpdate(e){if(this._pendingAttributeUpdate)return void z.error(new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__.default("mapview-webgl","Tried to update attribute data with a pending update"));const i=(0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_4__.createResolver)();return U("AttributeStoreView Update Requested",e),this._pendingAttributeUpdate={data:e,resolver:i},i.promise}update(){if(this._initialized&&(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isSome)(this._pendingAttributeUpdate)){const{data:t,resolver:e}=this._pendingAttributeUpdate,i=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrap)(this._data);for(let s=0;s<t.blocks.length;s++){const e=t.blocks[s],r=i[s];(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.andThen)(r,(t=>(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.andThen)(e,(e=>{U(`Updating block ${s}`,e),t.update(e)}))))}this._pendingAttributeUpdate=null,e(),this._onUpdate()}}bindTextures(t){this.update();const e=this._getDefaultTexture(t);if(!this._initialized)return t.bindTexture(e,_definitions_js__WEBPACK_IMPORTED_MODULE_13__.TEXTURE_BINDING_ATTRIBUTE_DATA_0),t.bindTexture(e,_definitions_js__WEBPACK_IMPORTED_MODULE_13__.TEXTURE_BINDING_ATTRIBUTE_DATA_1),t.bindTexture(e,_definitions_js__WEBPACK_IMPORTED_MODULE_13__.TEXTURE_BINDING_ATTRIBUTE_DATA_2),void t.bindTexture(e,_definitions_js__WEBPACK_IMPORTED_MODULE_13__.TEXTURE_BINDING_ATTRIBUTE_DATA_3);const i=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.unwrap)(this._data);this._locked&&!this._forceNextUpload||((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.forEachSome)(i,(e=>e.updateTexture(t,(()=>this._onUpdate())))),this._forceNextUpload=!1),t.bindTexture((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.mapOr)(i[0],e,(e=>e.getTexture(t))),_definitions_js__WEBPACK_IMPORTED_MODULE_13__.TEXTURE_BINDING_ATTRIBUTE_DATA_0),t.bindTexture((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.mapOr)(i[1],e,(e=>e.getTexture(t))),_definitions_js__WEBPACK_IMPORTED_MODULE_13__.TEXTURE_BINDING_ATTRIBUTE_DATA_1),t.bindTexture((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.mapOr)(i[2],e,(e=>e.getTexture(t))),_definitions_js__WEBPACK_IMPORTED_MODULE_13__.TEXTURE_BINDING_ATTRIBUTE_DATA_2),t.bindTexture((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.mapOr)(i[3],e,(e=>e.getTexture(t))),_definitions_js__WEBPACK_IMPORTED_MODULE_13__.TEXTURE_BINDING_ATTRIBUTE_DATA_3)}_getDefaultTexture(t){if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(this._defaultTexture)){const e={wrapMode:33071,pixelFormat:6408,dataType:5121,samplingMode:9728,width:1,height:1};this._defaultTexture=new _webgl_Texture_js__WEBPACK_IMPORTED_MODULE_11__.default(t,e,new Uint8Array(4))}return this._defaultTexture}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WGLRendererInfo": () => (/* binding */ p)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WGLTile": () => (/* binding */ r)
/* harmony export */ });
