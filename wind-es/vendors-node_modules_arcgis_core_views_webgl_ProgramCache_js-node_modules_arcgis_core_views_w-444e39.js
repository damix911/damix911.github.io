"use strict";
(self["webpackChunkwind_es"] = self["webpackChunkwind_es"] || []).push([["vendors-node_modules_arcgis_core_views_webgl_ProgramCache_js-node_modules_arcgis_core_views_w-444e39"],{
...
/* harmony export */   "InstanceCounter": () => (/* binding */ e)
/* harmony export */ });
...
*/
class e{constructor(){for(this._current=new Array,this._max=new Array,this._allocations=new Map;this._current.length<_enums_js__WEBPACK_IMPORTED_MODULE_0__.ResourceType.COUNT;)this._current.push(0),this._max.push(0)}resetMax(){for(this._max.length=0;this._max.length<this._current.length;)this._max.push(0)}increment(t,e){const s=++this._current[t];this._max[t]=Math.max(s,this._max[t])}decrement(t,e){--this._current[t]}get max(){return this._max}get current(){return this._current}get total(){return this.current.reduce(((t,e)=>t+e),0)}printResourceCount(){if(this.total>0){console.log("Live objects:");for(let e=0;e<_enums_js__WEBPACK_IMPORTED_MODULE_0__.ResourceType.COUNT;++e){const s=this._current[e];s>0&&console.log(`${_enums_js__WEBPACK_IMPORTED_MODULE_0__.ResourceType[e]}: ${s}`)}}if(this._allocations.size>0){console.log(`${this._allocations.size} live object allocations:`);const t=new Map;this._allocations.forEach((e=>{var s;t.set(e,(null!=(s=t.get(e))?s:0)+1)})),t.forEach(((t,e)=>console.log(t," : ",e)))}}}
...
/* harmony import */ var _InstanceCounter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./InstanceCounter.js */ "./node_modules/@arcgis/core/views/webgl/InstanceCounter.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "loadCapabilities": () => (/* binding */ o)
/* harmony export */ });
...
/* harmony import */ var _isWebGL2Context_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./isWebGL2Context.js */ "./node_modules/@arcgis/core/views/webgl/capabilities/isWebGL2Context.js");
...
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
function o(_,o){const T=o.disabledExtensions||{},s=o.debugWebGLExtensions||{};let x,C,A,F,G,O,B,D,M,c,X,d=null,g=null,P=null,L=null;return{get drawBuffers(){return X||(X=(0,_DrawBuffers_js__WEBPACK_IMPORTED_MODULE_1__.load)(_,T)),X},get instancing(){return x||(x=(0,_Instancing_js__WEBPACK_IMPORTED_MODULE_2__.load)(_)),x},get vao(){return C||(C=(0,_VertexArrayObjects_js__WEBPACK_IMPORTED_MODULE_5__.load)(_,T)),C},get compressedTextureETC(){return A||(A=l(_,T)),A},get compressedTextureS3TC(){return F||(F=u(_,T)),F},get textureFilterAnisotropic(){return G||(G=a(_,T)),G},get disjointTimerQuery(){return O||(O=(0,_DisjointTimerQuery_js__WEBPACK_IMPORTED_MODULE_0__.createDisjointTimerQuery)(_,T)),O},get textureFloat(){return B||(B=R(_,T)),B},get colorBufferFloat(){return D||(D=f(_,T)),D},get blendMinMax(){return M||(M=i(_,T)),M},get depthTexture(){return null===d&&(d=S(_,T,"depthTexture",!0,["WEBGL_depth_texture","MOZ_WEBGL_depth_texture","WEBKIT_WEBGL_depth_texture"])),d},get standardDerivatives(){return null===g&&(g=S(_,T,"standardDerivatives",!0,["OES_standard_derivatives"])),g},get shaderTextureLOD(){return null===P&&(P=S(_,T,"shaderTextureLOD",!0,["EXT_shader_texture_lod"])),P},get fragDepth(){return null===L&&(L=S(_,T,"fragDepth",!0,["EXT_frag_depth"])),L},get loseContext(){return c||(c=(0,_LoseContext_js__WEBPACK_IMPORTED_MODULE_4__.load)(_,s)),c},enable(t){return this[t]}}}function l(t,e){if(e.compressedTextureETC)return null;const r=t.getExtension("WEBGL_compressed_texture_etc");return r?{COMPRESSED_R11_EAC:r.COMPRESSED_R11_EAC,COMPRESSED_SIGNED_R11_EAC:r.COMPRESSED_SIGNED_R11_EAC,COMPRESSED_RG11_EAC:r.COMPRESSED_RG11_EAC,COMPRESSED_SIGNED_RG11_EAC:r.COMPRESSED_SIGNED_RG11_EAC,COMPRESSED_RGB8_ETC2:r.COMPRESSED_RGB8_ETC2,COMPRESSED_SRGB8_ETC2:r.COMPRESSED_SRGB8_ETC2,COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2:r.COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2,COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2:r.COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2,COMPRESSED_RGBA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC,COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC}:null}function u(t,e){if(e.compressedTextureS3TC)return null;const r=t.getExtension("WEBGL_compressed_texture_s3tc");return r?{COMPRESSED_RGB_S3TC_DXT1:r.COMPRESSED_RGB_S3TC_DXT1_EXT,COMPRESSED_RGBA_S3TC_DXT1:r.COMPRESSED_RGBA_S3TC_DXT1_EXT,COMPRESSED_RGBA_S3TC_DXT3:r.COMPRESSED_RGBA_S3TC_DXT3_EXT,COMPRESSED_RGBA_S3TC_DXT5:r.COMPRESSED_RGBA_S3TC_DXT5_EXT}:null}function i(t,e){if((0,_isWebGL2Context_js__WEBPACK_IMPORTED_MODULE_3__.default)(t))return{MIN:t.MIN,MAX:t.MAX};if(e.blendMinMax)return null;{const e=t.getExtension("EXT_blend_minmax");return e?{MIN:e.MIN_EXT,MAX:e.MAX_EXT}:null}}function a(t,e){if(e.textureFilterAnisotropic)return null;const r=t.getExtension("EXT_texture_filter_anisotropic")||t.getExtension("MOZ_EXT_texture_filter_anisotropic")||t.getExtension("WEBKIT_EXT_texture_filter_anisotropic");return r?{MAX_TEXTURE_MAX_ANISOTROPY:r.MAX_TEXTURE_MAX_ANISOTROPY_EXT,TEXTURE_MAX_ANISOTROPY:r.TEXTURE_MAX_ANISOTROPY_EXT}:null}function R(t,e){if((0,_isWebGL2Context_js__WEBPACK_IMPORTED_MODULE_3__.default)(t))return{textureFloat:!0,textureFloatLinear:!e.textureFloatLinear&&!!t.getExtension("OES_texture_float_linear"),textureHalfFloat:!0,textureHalfFloatLinear:!e.textureHalfFloatLinear&&!!t.getExtension("OES_texture_half_float_linear"),HALF_FLOAT:t.HALF_FLOAT};if(t instanceof WebGLRenderingContext){const r=!e.textureHalfFloat&&t.getExtension("OES_texture_half_float");return{textureFloat:!e.textureFloat&&!!t.getExtension("OES_texture_float"),textureFloatLinear:!e.textureFloatLinear&&!!t.getExtension("OES_texture_float_linear"),textureHalfFloat:!!r,textureHalfFloatLinear:!e.textureHalfFloatLinear&&!!t.getExtension("OES_texture_half_float_linear"),HALF_FLOAT:r?r.HALF_FLOAT_OES:void 0}}return null}function f(t,e){if((0,_isWebGL2Context_js__WEBPACK_IMPORTED_MODULE_3__.default)(t)){const r=!e.colorBufferFloat&&t.getExtension("EXT_color_buffer_half_float"),_=!e.colorBufferFloat&&t.getExtension("EXT_color_buffer_float"),n=!e.colorBufferFloat&&t.getExtension("EXT_float_blend");return r||_||n?{textureFloat:!!_,textureHalfFloat:!!r,R16F:t.R16F,RG16F:t.RG16F,RGBA16F:t.RGBA16F,R32F:t.R32F,RG32F:t.RG32F,RGBA32F:t.RGBA32F,R11F_G11F_B10F:t.R11F_G11F_B10F,RGB16F:t.RGB16F}:null}if(t instanceof WebGLRenderingContext){const r=!e.colorBufferFloat&&t.getExtension("EXT_color_buffer_half_float"),_=!e.colorBufferFloat&&t.getExtension("WEBGL_color_buffer_float"),n=!e.colorBufferFloat&&t.getExtension("EXT_float_blend");return r||_||n?{textureFloat:!!_,textureHalfFloat:!!r,RGBA16F:r?r.RGBA16F_EXT:void 0,RGB16F:r?r.RGB16F_EXT:void 0,RGBA32F:_?_.RGBA32F_EXT:void 0}:null}return null}function S(t,e,r,n,E){if(n&&(0,_isWebGL2Context_js__WEBPACK_IMPORTED_MODULE_3__.default)(t))return!0;if(e[r])return!1;for(const _ of E)if(t.getExtension(_))return!0;return!1}
