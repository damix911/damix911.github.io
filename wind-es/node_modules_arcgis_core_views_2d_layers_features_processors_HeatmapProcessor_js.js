"use strict";
(self["webpackChunkwind_es"] = self["webpackChunkwind_es"] || []).push([["node_modules_arcgis_core_views_2d_layers_features_processors_HeatmapProcessor_js"],{
...
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
class p{constructor(e,t){this.offset=e,this.extent=t}}function c(e){const t=e.key,s=new Map,r=256,i=_engine_webgl_definitions_js__WEBPACK_IMPORTED_MODULE_9__.TILE_SIZE,o=e.tileInfoView.tileInfo.isWrappable;return s.set((0,_support_tileUtils_js__WEBPACK_IMPORTED_MODULE_11__.getPow2NeighborKey)(t,-1,-1,o).id,new p([-i,-i],[i-r,i-r,i,i])),s.set((0,_support_tileUtils_js__WEBPACK_IMPORTED_MODULE_11__.getPow2NeighborKey)(t,0,-1,o).id,new p([0,-i],[0,i-r,i,i])),s.set((0,_support_tileUtils_js__WEBPACK_IMPORTED_MODULE_11__.getPow2NeighborKey)(t,1,-1,o).id,new p([i,-i],[0,i-r,r,i])),s.set((0,_support_tileUtils_js__WEBPACK_IMPORTED_MODULE_11__.getPow2NeighborKey)(t,-1,0,o).id,new p([-i,0],[i-r,0,i,i])),s.set((0,_support_tileUtils_js__WEBPACK_IMPORTED_MODULE_11__.getPow2NeighborKey)(t,1,0,o).id,new p([i,0],[0,0,r,i])),s.set((0,_support_tileUtils_js__WEBPACK_IMPORTED_MODULE_11__.getPow2NeighborKey)(t,-1,1,o).id,new p([-i,i],[i-r,0,i,r])),s.set((0,_support_tileUtils_js__WEBPACK_IMPORTED_MODULE_11__.getPow2NeighborKey)(t,0,1,o).id,new p([0,i],[0,0,i,r])),s.set((0,_support_tileUtils_js__WEBPACK_IMPORTED_MODULE_11__.getPow2NeighborKey)(t,1,1,o).id,new p([i,i],[0,0,r,r])),s}let l=class extends _BaseProcessor_js__WEBPACK_IMPORTED_MODULE_10__.default{constructor(){super(...arguments),this.type="heatmap",this._tileKeyToFeatureSets=new Map}initialize(){this.handles.add([this.tileStore.on("update",this.onTileUpdate.bind(this))])}async update(e,t){const s=t.schema.processors[0];if("heatmap"!==s.type)return;(0,_core_accessorSupport_diffUtils_js__WEBPACK_IMPORTED_MODULE_7__.diff)(this._schema,s)&&(e.mesh=!0,this._schema=s)}onTileUpdate(e){for(const t of e.removed)this._tileKeyToFeatureSets.delete(t.key.id)}onTileClear(e){const t={clear:!0};return this._tileKeyToFeatureSets.delete(e.key.id),this.remoteClient.invoke("tileRenderer.onTileData",{tileKey:e.id,data:t})}async onTileMessage(e,r,i){this._tileKeyToFeatureSets.has(e.key.id)||this._tileKeyToFeatureSets.set(e.key.id,new Map);const a=this._tileKeyToFeatureSets.get(e.key.id);if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isSome)(r.addOrUpdate)&&r.addOrUpdate.hasFeatures&&a.set(r.addOrUpdate.instance,r),r.end){const t=[],r=c(e);this._tileKeyToFeatureSets.forEach(((i,o)=>{if(o===e.key.id)i.forEach((e=>(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.andThen)(e.addOrUpdate,(e=>t.push(e)))));else if(r.has(o)){const e=r.get(o),[a,n]=e.offset;i.forEach((e=>(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.andThen)(e.addOrUpdate,(e=>{const s=e.transform(a,n,1,1);t.push(s)}))))}}));const a=(0,_renderers_support_heatmapUtils_js__WEBPACK_IMPORTED_MODULE_8__.calculateHeatmapIntensityInfoReaders)(t,this._schema.mesh,512,512),n={tileKey:e.key.id,intensityInfo:a},d=[a.matrix];return this.remoteClient.invoke("tileRenderer.onTileData",n,{...i,transferList:d})}}onTileError(e,t,s){return this.remoteClient.invoke("tileRenderer.onTileError",{tileKey:e.id,error:t},s)}};l=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_6__.subclass)("esri.views.2d.layers.features.processors.HeatmapProcessor")],l);var h=l;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (h);
