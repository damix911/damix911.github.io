 ...
 */
(self["webpackChunkwind_es"] = self["webpackChunkwind_es"] || []).push([["vendors-node_modules_arcgis_core_views_2d_engine_vectorTiles_WorkerTileHandler_js-node_module-f95798"],{
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _core_pbf_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../core/pbf.js */ \"./node_modules/@arcgis/core/core/pbf.js\");\n/* harmony import */ var _core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../core/promiseUtils.js */ \"./node_modules/@arcgis/core/core/promiseUtils.js\");\n/* harmony import */ var _Feature_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Feature.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/Feature.js\");\n/* harmony import */ var _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./IndexMemoryBuffer.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/IndexMemoryBuffer.js\");\n/* harmony import */ var _SourceLayerData_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./SourceLayerData.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/SourceLayerData.js\");\n/* harmony import */ var _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./VertexMemoryBuffer.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/VertexMemoryBuffer.js\");\n/* harmony import */ var _buckets_CircleBucket_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./buckets/CircleBucket.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/buckets/CircleBucket.js\");\n/* harmony import */ var _buckets_FillBucket_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./buckets/FillBucket.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/buckets/FillBucket.js\");\n/* harmony import */ var _buckets_LineBucket_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./buckets/LineBucket.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/buckets/LineBucket.js\");\n/* harmony import */ var _buckets_SymbolBucket_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./buckets/SymbolBucket.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/buckets/SymbolBucket.js\");\n/* harmony import */ var _webgl_TileClipper_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../webgl/TileClipper.js */ \"./node_modules/@arcgis/core/views/2d/engine/webgl/TileClipper.js\");\n/* harmony import */ var _tiling_enums_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../tiling/enums.js */ \"./node_modules/@arcgis/core/views/2d/tiling/enums.js\");\n/*\nAll material copyright ESRI, All Rights Reserved, unless otherwise specified.\nSee https://js.arcgis.com/4.21/esri/copyright.txt for details.\n*/\nconst k=8,d=14,T=5;class w{constructor(t,r,s,i,o){if(this._pbfTiles={},this._tileClippers={},this._client=s,this._tile=r,o){this._styleLayerUIDs=new Set;for(const e of o)this._styleLayerUIDs.add(e)}this._styleRepository=i,this._layers=this._styleRepository.layers;const[c,n,l]=r.tileKey.split(\"/\").map(parseFloat);this._level=c;const a=k+Math.max((this._level-d)*T,0);for(const u of Object.keys(t)){const r=t[u];this._pbfTiles[u]=new _core_pbf_js__WEBPACK_IMPORTED_MODULE_0__.default(new Uint8Array(r.protobuff),new DataView(r.protobuff));if(r.refKey){const[e]=r.refKey.split(\"/\").map(parseFloat),t=c-e;if(t>0){const e=(1<<t)-1,r=n&e,s=l&e;this._tileClippers[u]=new _webgl_TileClipper_js__WEBPACK_IMPORTED_MODULE_10__.TileClipper(t,r,s,8,a)}}this._tileClippers[u]||(this._tileClippers[u]=new _webgl_TileClipper_js__WEBPACK_IMPORTED_MODULE_10__.SimpleBuilder)}}_canParseStyleLayer(e){return!this._styleLayerUIDs||this._styleLayerUIDs.has(e)}async parse(e){const t=this._initialize(e),{returnedBuckets:r}=t;this._processLayers(t),this._linkReferences(t),this._filterFeatures(t);const s=new Set,i={};for(const c of r)c.getResources(c.tileClipper,s,i);if(this._tile.status===_tiling_enums_js__WEBPACK_IMPORTED_MODULE_11__.TileStatus.INVALID)return Promise.resolve([]);const o=this._fetchResources(s,i,e);return Promise.all(o).then((()=>this._processFeatures(t.returnedBuckets)))}_initialize(e){return{signal:e&&e.signal,sourceNameToTileData:this._parseTileData(this._pbfTiles),layers:this._layers,zoom:this._level,sourceNameToTileClipper:this._tileClippers,sourceNameToUniqueSourceLayerBuckets:{},sourceNameToUniqueSourceLayers:{},returnedBuckets:[],layerIdToBucket:{},referencerUIDToReferencedId:new Map}}_processLayers(e){const{sourceNameToTileData:t,layers:r,zoom:s,sourceNameToTileClipper:i,sourceNameToUniqueSourceLayerBuckets:o,sourceNameToUniqueSourceLayers:c,returnedBuckets:n,layerIdToBucket:l,referencerUIDToReferencedId:a}=e;for(let u=r.length-1;u>=0;u--){const e=r[u];if(!this._canParseStyleLayer(e.uid)||e.minzoom&&s<Math.floor(e.minzoom)||e.maxzoom&&s>=e.maxzoom||0===e.type)continue;if(!t[e.source]||!i[e.source])continue;const f=t[e.source],p=i[e.source],h=e.sourceLayer,m=f[h];if(m){let t=c[e.source];if(t||(t=c[e.source]=new Set),t.add(e.sourceLayer),e.refLayerId)a.set(e.uid,e.refLayerId);else{const t=this._createBucket(e);if(t){t.layerUIDs=[e.uid],t.layerExtent=m.extent,t.tileClipper=p;let r=o[e.source];r||(r=o[e.source]={});let s=r[h];s||(s=r[h]=[]),s.push(t),n.push(t),l[e.id.toLowerCase()]=t}}}}}_linkReferences(e){const{layerIdToBucket:t,referencerUIDToReferencedId:r}=e;r.forEach(((e,r)=>{e=e.toLowerCase(),t[e]&&t[e].layerUIDs.push(r)}))}_filterFeatures(e){const{signal:s,sourceNameToTileData:i,sourceNameToUniqueSourceLayerBuckets:o,sourceNameToUniqueSourceLayers:c}=e,n=10*this._level,l=10*(this._level+1),a=[],u=[];for(const t of Object.keys(c)){c[t].forEach((e=>{a.push(e),u.push(t)}))}for(let f=0;f<a.length;f++){const e=u[f],c=a[f];if(!i[e]||!o[e])continue;const p=i[e][c],h=o[e][c];if(!h||0===h.length)continue;if((0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__.isAborted)(s))return;const m=p.getData();for(;m.nextTag(2);){const e=m.getMessage(),t=new _Feature_js__WEBPACK_IMPORTED_MODULE_2__.default(e,p);e.release();const s=t.values;if(s){const e=s._minzoom;if(e&&e>=l)continue;const t=s._maxzoom;if(t&&t<=n)continue}for(const r of h)r.pushFeature(t)}}}_fetchResources(e,t,r){const s=[],i=this._tile.getWorkerTileHandler();let o,c;e.size>0&&(o=i.fetchSprites(e,this._client,r),s.push(o));for(const n in t){const e=t[n];e.size>0&&(c=i.fetchGlyphs(this._tile.tileKey,n,e,this._client,r),s.push(c))}return s}_processFeatures(e){const t=e.filter((e=>e.hasFeatures()||this._canParseStyleLayer(e.layer.uid)));for(const r of t)r.processFeatures(r.tileClipper);return t}_parseTileData(e){const t={};for(const r of Object.keys(e)){const s=e[r],o={};for(;s.next();)switch(s.tag()){case 3:{const e=s.getMessage(),t=new _SourceLayerData_js__WEBPACK_IMPORTED_MODULE_4__.default(e);e.release(),o[t.name]=t;break}default:s.skip()}t[r]=o}return t}_createBucket(e){switch(e.type){case 0:return null;case 1:return this._createFillBucket(e);case 2:return this._createLineBucket(e);case 4:return this._createCircleBucket(e);case 3:return this._createSymbolBucket(e)}}_createFillBucket(e){return new _buckets_FillBucket_js__WEBPACK_IMPORTED_MODULE_7__.default(e,this._level,this._tile.getWorkerTileHandler().getSpriteItems(),new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.FillVertexBuffer(e.fillMaterial.getStride()),new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_3__.TriangleIndexBuffer,new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.OutlineVertexBuffer(e.outlineMaterial.getStride()),new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_3__.TriangleIndexBuffer)}_createLineBucket(e){return new _buckets_LineBucket_js__WEBPACK_IMPORTED_MODULE_8__.default(e,this._level,this._tile.getWorkerTileHandler().getSpriteItems(),new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.LineVertexBuffer(e.lineMaterial.getStride()),new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_3__.TriangleIndexBuffer)}_createCircleBucket(e){return new _buckets_CircleBucket_js__WEBPACK_IMPORTED_MODULE_6__.default(e,this._level,this._tile.getWorkerTileHandler().getSpriteItems(),new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.CircleVertexBuffer(e.circleMaterial.getStride()),new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_3__.TriangleIndexBuffer)}_createSymbolBucket(e){const t=this._tile;return new _buckets_SymbolBucket_js__WEBPACK_IMPORTED_MODULE_9__.default(e,this._level,new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.SymbolVertexBuffer(e.iconMaterial.getStride()),new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_3__.TriangleIndexBuffer,new _VertexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_5__.SymbolVertexBuffer(e.textMaterial.getStride()),new _IndexMemoryBuffer_js__WEBPACK_IMPORTED_MODULE_3__.TriangleIndexBuffer,t.placementEngine,t.getWorkerTileHandler())}}/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (w);\n\n\n//# sourceURL=webpack://wind-es/./node_modules/@arcgis/core/views/2d/engine/vectorTiles/TileParser.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _core_maybe_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../core/maybe.js */ \"./node_modules/@arcgis/core/core/maybe.js\");\n/* harmony import */ var _core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../core/promiseUtils.js */ \"./node_modules/@arcgis/core/core/promiseUtils.js\");\n/* harmony import */ var _Placement_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Placement.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/Placement.js\");\n/* harmony import */ var _TileParser_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TileParser.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/TileParser.js\");\n/* harmony import */ var _tiling_enums_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../tiling/enums.js */ \"./node_modules/@arcgis/core/views/2d/tiling/enums.js\");\n/*\nAll material copyright ESRI, All Rights Reserved, unless otherwise specified.\nSee https://js.arcgis.com/4.21/esri/copyright.txt for details.\n*/\nclass n{constructor(e,t,r,n){this.status=_tiling_enums_js__WEBPACK_IMPORTED_MODULE_4__.TileStatus.INITIALIZED,this.placementEngine=new _Placement_js__WEBPACK_IMPORTED_MODULE_2__.PlacementEngine,this.tileKey=e,this.refKeys=t,this._workerTileHandler=r,this._styleRepository=n}release(){this.tileKey=\"\",this.refKeys=null,this.status=_tiling_enums_js__WEBPACK_IMPORTED_MODULE_4__.TileStatus.INITIALIZED,this._workerTileHandler=null}async parse(s,r,n){const a=n&&n.signal;if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)(a)){const e=()=>{a.removeEventListener(\"abort\",e),this.status=_tiling_enums_js__WEBPACK_IMPORTED_MODULE_4__.TileStatus.INVALID};a.addEventListener(\"abort\",e)}let o;try{o=await this._parse(s,n)}catch(h){if((0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__.isAbortError)(h))throw h;return{result:[],transferList:[]}}this.status=_tiling_enums_js__WEBPACK_IMPORTED_MODULE_4__.TileStatus.READY;const l=[];for(const e of o){const t=e.serialize();l.push(t)}return{result:l,transferList:l.length<=r&&l}}setObsolete(){this.status=_tiling_enums_js__WEBPACK_IMPORTED_MODULE_4__.TileStatus.INVALID}getLayers(){return this._workerTileHandler.getLayers()}getWorkerTileHandler(){return this._workerTileHandler}async _parse(e,t){const s=e.sourceName2DataAndRefKey;if(0===Object.keys(s).length)return[];this.status=_tiling_enums_js__WEBPACK_IMPORTED_MODULE_4__.TileStatus.MODIFIED;return new _TileParser_js__WEBPACK_IMPORTED_MODULE_3__.default(s,this,t.client,this._styleRepository,e.styleLayerUIDs).parse(t)}}/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (n);\n\n\n//# sourceURL=webpack://wind-es/./node_modules/@arcgis/core/views/2d/engine/vectorTiles/WorkerTile.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../core/promiseUtils.js */ \"./node_modules/@arcgis/core/core/promiseUtils.js\");\n/* harmony import */ var _WorkerTile_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./WorkerTile.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/WorkerTile.js\");\n/* harmony import */ var _style_StyleRepository_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style/StyleRepository.js */ \"./node_modules/@arcgis/core/views/2d/engine/vectorTiles/style/StyleRepository.js\");\n/*\nAll material copyright ESRI, All Rights Reserved, unless otherwise specified.\nSee https://js.arcgis.com/4.21/esri/copyright.txt for details.\n*/\nclass r{constructor(){this._spriteInfo={},this._glyphInfo={}}reset(){return this._spriteInfo={},this._glyphInfo={},Promise.resolve()}getLayers(){var e;return null==(e=this._styleRepository)?void 0:e.layers}async createTileAndParse(s,r){const{key:o}=s,i={};for(const e of Object.keys(s.sourceName2DataAndRefKey)){const t=s.sourceName2DataAndRefKey[e];i[e]=t.refKey}const n=new _WorkerTile_js__WEBPACK_IMPORTED_MODULE_1__.default(o,i,this,this._styleRepository);try{return await n.parse(s,this._vectorTileLayerMaxBuffers,r)}catch(l){if(n.setObsolete(),n.release(),!(0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_0__.isAbortError)(l))throw l;return null}}updateStyle(e){if(!e||0===e.length||!this._styleRepository)return;const t=this._styleRepository;for(const s of e){const e=s.type,r=s.data;switch(e){case 0:t.setPaintProperties(r.layer,r.paint);break;case 1:t.setLayoutProperties(r.layer,r.layout);break;case 3:t.deleteStyleLayer(r.layer);break;case 2:t.setStyleLayer(r.layer,r.index)}}}setStyle(e){this._styleRepository=new _style_StyleRepository_js__WEBPACK_IMPORTED_MODULE_2__.default(e.style),this._spriteInfo={},this._glyphInfo={},this._vectorTileLayerMaxBuffers=e.vectorTileLayerMaxBuffers}fetchSprites(e,t,s){const r=[],o=this._spriteInfo;return e.forEach((e=>{void 0===o[e.name]&&r.push(e)})),0===r.length?Promise.resolve():t.invoke(\"getSprites\",r,{signal:s&&s.signal}).then((e=>{for(const t in e){const s=e[t];o[t]=s}}))}getSpriteItems(){return this._spriteInfo}fetchGlyphs(e,t,s,r,o){const i=[];let n=this._glyphInfo[t];return n?s.forEach((e=>{n[e]||i.push(e)})):(n=this._glyphInfo[t]=[],s.forEach((e=>i.push(e)))),0===i.length?Promise.resolve():r.invoke(\"getGlyphs\",{tileID:e,font:t,codePoints:i},o).then((e=>{for(let t=0;t<e.length;t++)e[t]&&(n[t]=e[t])}))}getGlyphItems(e){return this._glyphInfo[e]}}/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (r);\n\n\n//# sourceURL=webpack://wind-es/./node_modules/@arcgis/core/views/2d/engine/vectorTiles/WorkerTileHandler.js?");
