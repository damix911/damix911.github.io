"use strict";
(self["webpackChunkwind_es"] = self["webpackChunkwind_es"] || []).push([["vendors-node_modules_arcgis_core_views_2d_engine_webgl_util_debug_js-node_modules_arcgis_core-524ecc"],{
...
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
const u=50,f=4,S=8;let w=0;class g extends _WGLTile_js__WEBPACK_IMPORTED_MODULE_9__.WGLTile{constructor(t,r,s){super(t,r),this.instanceId=w++,this.patchCount=0,this._renderState={current:{geometry:new Map,metrics:null},next:null,swap:!1,swapFrames:0,locked:!1},this._patches=new _core_CircularArray_js__WEBPACK_IMPORTED_MODULE_0__.default(100),this._lastCommitTime=0,this._lastMessageWasClear=!1,this.transforms.labelMat2d=(0,_chunks_mat2df32_js__WEBPACK_IMPORTED_MODULE_4__.c)(),this._store=s}destroy(){super.destroy(),this._renderState.current.geometry.forEach((e=>e.destroy()))}get labelMetrics(){return this._renderState.current.metrics}get hasData(){return!!this._renderState.current.geometry.size}getGeometry(e){return this._renderState.current.geometry.get(e)}setTransform(e,t){super.setTransform(e,t);const r=this.transforms.labelMat2d,s=e.getScreenTransform(r,t),h=(0,_chunks_vec2f32_js__WEBPACK_IMPORTED_MODULE_6__.c)();(0,_chunks_vec2_js__WEBPACK_IMPORTED_MODULE_5__.t)(h,this.coords,s),(0,_chunks_mat2d_js__WEBPACK_IMPORTED_MODULE_3__.i)(r),(0,_chunks_mat2d_js__WEBPACK_IMPORTED_MODULE_3__.t)(r,r,h),(0,_chunks_mat2d_js__WEBPACK_IMPORTED_MODULE_3__.m)(r,e.viewMat2d,r)}patch(e){this.patchCount++,e.clear&&this._lastMessageWasClear||(this._lastMessageWasClear=e.clear,e.clear&&this._patches.size>=u&&this._dropPatches(),this._patches.enqueue(e),this.requestRender())}commit(e){if(this._lastCommitTime!==e.time){this._lastCommitTime=e.time;for(let e=0;e<f;e++)this._updateMesh();this._renderState.swap&&(this._swapRenderStates(),this.requestRender())}}lock(){this._renderState.locked=!0}unlock(){this._renderState.locked=!1,this._flushUpdates(),this._swap()}_swapRenderStates(){if(this._renderState.next){if(this._renderState.locked)return this._renderState.swap=!0,void this.requestRender();if(this._renderState.swap=!0,0===this._renderState.swapFrames)return this._renderState.swapFrames=S,void this.requestRender();1==this._renderState.swapFrames--?this._swap():this.requestRender()}}_swap(){this._renderState.swap&&(this._renderState.swap=!1,(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isSome)(this._renderState.next)&&(this._renderState.current.geometry.forEach((e=>e.destroy())),this._renderState.current=this._renderState.next,this._renderState.next=null))}_flushUpdates(){let e=this._patches.maxSize;for(;this._patches.size&&e--;)this._updateMesh(),this._swap()}_updateMesh(){const e=this._patches.peek();if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isSome)(e)&&e.clear&&null!==this._renderState.next)return;const r=this._patches.dequeue();if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isSome)(r)){if(!0===r.clear){if(!this.isReady)return;return this._renderState.next,void(this._renderState.next={geometry:new Map,metrics:null})}this.requestRender(),this._patch(r),r.end&&(this.ready(),this._swapRenderStates())}}_patch(e){(0,_Utils_js__WEBPACK_IMPORTED_MODULE_8__.forEachGeometryType)((t=>{this._remove(t,e.remove),this._insert(e.type,t,e.addOrUpdate,e.clear)}))}_insert(e,t,i,a){try{const n=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.unwrapOr)(this._renderState.next,this._renderState.current),h=null==i?void 0:i.data[t],o=n.geometry;if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(h))return;o.has(t)||o.set(t,new _cpuMapped_Geometry_js__WEBPACK_IMPORTED_MODULE_11__.Geometry(t,this.stage)),o.get(t).insert(e,h),t===_enums_js__WEBPACK_IMPORTED_MODULE_7__.WGLGeometryType.LABEL&&this._insertLabelMetrics(e,h.metrics,a)}catch(n){}}_insertLabelMetrics(e,t,i){const a=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.unwrapOr)(this._renderState.next,this._renderState.current);if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(t))return;const n=_collisions_MetricReader_js__WEBPACK_IMPORTED_MODULE_10__.MetricReader.from(t);if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(a.metrics))a.metrics=n;else{if("update"===e){const e=n.getCursor();for(;e.next();)a.metrics.delete(e.id)}a.metrics.link(n)}}_remove(e,t){const s=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.unwrapOr)(this._renderState.next,this._renderState.current).geometry.get(e);t&&t.length&&s&&(s.remove(t),this._removeLabelMetrics(t))}_removeLabelMetrics(e){const{metrics:t}=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.unwrapOr)(this._renderState.next,this._renderState.current);if(!(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(t)&&e.length)for(const r of e)for(;t.delete(r););}_dropPatches(){const e=new Array;let t=!1;for(;this._patches.size;){const r=this._patches.dequeue();if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_2__.isNone)(r))break;if(r.clear){if(t)break;t=!0}e.push(r)}this._patches.clear(),e.forEach((e=>this._patches.enqueue(e)))}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Geometry": () => (/* binding */ e)
/* harmony export */ });
