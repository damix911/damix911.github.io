"use strict";
(self["webpackChunkwind_es"] = self["webpackChunkwind_es"] || []).push([["vendors-node_modules_arcgis_core_symbols_cim_cimAnalyzer_js"],{
...
/* harmony export */   "buildSDF": () => (/* binding */ a),
/* harmony export */   "getExtent": () => (/* binding */ f),
/* harmony export */   "getSDFInfo": () => (/* binding */ r),
/* harmony export */   "getSDFMetrics": () => (/* binding */ m),
...
/* harmony import */ var _packingUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./packingUtils.js */ "./node_modules/@arcgis/core/symbols/cim/packingUtils.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "analyzeCIMResource": () => (/* binding */ T),
/* harmony export */   "analyzeCIMSymbol": () => (/* binding */ k)
/* harmony export */ });
...
/* harmony import */ var _CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./CIMSymbolHelper.js */ "./node_modules/@arcgis/core/symbols/cim/CIMSymbolHelper.js");
/* harmony import */ var _SDFHelper_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./SDFHelper.js */ "./node_modules/@arcgis/core/symbols/cim/SDFHelper.js");
...
/* harmony import */ var _views_2d_arcade_callExpressionWithFeature_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../views/2d/arcade/callExpressionWithFeature.js */ "./node_modules/@arcgis/core/views/2d/arcade/callExpressionWithFeature.js");
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
const u=_core_Logger_js__WEBPACK_IMPORTED_MODULE_1__.default.getLogger("esri.symbols.cim.cimAnalyzer");function y(e){switch(e){case"Butt":return 0;case"Square":return 2;case"Round":default:return 1}}function h(e){switch(e){case"Bevel":return 0;case"Miter":return 2;case"Round":default:return 1}}function g(e){switch(e){case"Left":default:return"left";case"Right":return"right";case"Center":return"center";case"Justify":return"justify"}}function d(e){switch(e){case"Top":default:return"top";case"Center":return"middle";case"Baseline":return"baseline";case"Bottom":return"bottom"}}function S(e){let t="normal",i="normal";if(e){const o=e.toLowerCase();-1!==o.indexOf("italic")?t="italic":-1!==o.indexOf("oblique")&&(t="oblique"),-1!==o.indexOf("bold")?i="bold":-1!==o.indexOf("light")&&(i="lighter")}return{style:t,weight:i}}function v(e){return e.underline?"underline":e.strikethrough?"line-through":"none"}function N(e,t,i,o){let r;e[t]?r=e[t]:(r={},e[t]=r),r[i]=o}function b(e){const t=e.markerPlacement;return t&&t.angleToLine?1:0}async function k(e,t,i,o){const n=null!=i?i:[];if(!e)return n;let a,l;const s={};if("CIMSymbolReference"!==e.type)return u.error("Expect cim type to be 'CIMSymbolReference'"),n;if(a=e.symbol,l=e.primitiveOverrides,l){const e=[];for(const i of l){const o=i.valueExpressionInfo;if(o&&t){const n=o.expression,a=(0,_support_arcadeOnDemand_js__WEBPACK_IMPORTED_MODULE_4__.createRendererExpression)(n,t.spatialReference,t.fields).then((e=>{e&&N(s,i.primitiveName,i.propertyName,e)}));e.push(a)}else null!=i.value&&N(s,i.primitiveName,i.propertyName,i.value)}await Promise.all(e)}switch(a.type){case"CIMPointSymbol":case"CIMLineSymbol":case"CIMPolygonSymbol":O(a,l,s,t,n,o)}return n}function O(e,t,i,o,r,n){if(!e)return;const s=e.symbolLayers;if(!s)return;let c;const f=_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getSize(e);"CIMPointSymbol"===e.type&&"Map"===e.angleAlignment&&(c=1);let m=s.length;for(;m--;){const a=s[m];if(!a||!1===a.enable)continue;const p=[];switch(_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.OverrideHelper.findApplicableOverrides(a,t,p),a.type){case"CIMSolidFill":C(a,i,p,o,r);break;case"CIMPictureFill":P(a,i,p,o,r);break;case"CIMHatchFill":L(a,i,p,o,r);break;case"CIMGradientFill":M(a,i,p,o,r);break;case"CIMSolidStroke":X(a,i,p,o,r,"CIMPolygonSymbol"===e.type,f);break;case"CIMPictureStroke":I(a,i,p,o,r,"CIMPolygonSymbol"===e.type,f);break;case"CIMGradientStroke":x(a,i,p,o,r,"CIMPolygonSymbol"===e.type,f);break;case"CIMCharacterMarker":if(w(a,i,p,o,r))break;break;case"CIMPictureMarker":if(w(a,i,p,o,r))break;"CIMLineSymbol"===e.type&&(c=b(a)),z(a,i,p,o,r,c,f);break;case"CIMVectorMarker":if(w(a,i,p,o,r))break;"CIMLineSymbol"===e.type&&(c=b(a)),J(a,i,p,o,r,c,f,n);break;default:u.error("Cannot analyze CIM layer",a.type)}}}function C(e,t,i,r,n){const a=e.primitiveName,l=(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(e.color),[s,c]=D(i,a),m=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(e)+c).toString();n.push({type:"fill",templateHash:m,materialHash:s?()=>m:m,cim:e,materialOverrides:null,colorLocked:e.colorLocked,color:F(a,t,"Color",r,l,j),height:0,angle:0,offsetX:0,offsetY:0,scaleX:1,effects:e.effects})}function P(e,t,i,r,n){const a=e.primitiveName,l=e.tintColor?(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(e.tintColor):{r:255,g:255,b:255,a:1},[s,c]=D(i,a),m=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(e)+c).toString(),p=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(`${e.url}${JSON.stringify(e.colorSubstitutions)}`).toString();n.push({type:"fill",templateHash:m,materialHash:s?()=>p:p,cim:e,materialOverrides:null,colorLocked:e.colorLocked,effects:e.effects,color:F(a,t,"TintColor",r,l,j),height:F(a,t,"Height",r,e.height),scaleX:F(a,t,"ScaleX",r,e.scaleX),angle:F(a,t,"Rotation",r,e.rotation),offsetX:F(a,t,"OffsetX",r,e.offsetX),offsetY:F(a,t,"OffsetY",r,e.offsetY)})}function L(e,t,i,r,n){const a=["Rotation","OffsetX","OffsetY"],l=i.filter((t=>t.primitiveName!==e.primitiveName&&-1===a.indexOf(t.propertyName))),s=e.primitiveName,[c,f]=D(i,s),m=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(e)+f).toString(),p=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(`${e.separation}${JSON.stringify(e.lineSymbol)}`).toString();n.push({type:"fill",templateHash:m,materialHash:c?W(p,t,l,r):p,cim:e,materialOverrides:l,colorLocked:e.colorLocked,effects:e.effects,color:{r:255,g:255,b:255,a:1},height:F(s,t,"Separation",r,e.separation),scaleX:1,angle:F(s,t,"Rotation",r,e.rotation),offsetX:F(s,t,"OffsetX",r,e.offsetX),offsetY:F(s,t,"OffsetY",r,e.offsetY)})}function M(e,t,i,r,n){const a=e.primitiveName,[l,s]=D(i,a),c=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(e)+s).toString();n.push({type:"fill",templateHash:c,materialHash:l?W(c,t,i,r):c,cim:e,materialOverrides:null,colorLocked:e.colorLocked,effects:e.effects,color:{r:128,g:128,b:128,a:1},height:0,angle:0,offsetX:0,offsetY:0,scaleX:1})}function X(e,t,i,r,n,a,l){const s=e.primitiveName,c=(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(e.color),m=void 0!==e.width?e.width:4,p=y(e.capStyle),u=h(e.joinStyle),g=e.miterLimit,[d,S]=D(i,s),v=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(e)+S).toString();n.push({type:"line",templateHash:v,materialHash:d?()=>v:v,cim:e,materialOverrides:null,isOutline:a,colorLocked:e.colorLocked,effects:e.effects,color:F(s,t,"Color",r,c,j),width:F(s,t,"Width",r,m),cap:F(s,t,"CapStyle",r,p),join:F(s,t,"JoinStyle",r,u),miterLimit:F(s,t,"MiterLimit",r,g),referenceWidth:l,zOrder:A(e.name),isDashed:!1})}function I(e,t,i,r,n,a,l){const s=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(`${e.url}${JSON.stringify(e.colorSubstitutions)}`).toString(),c=e.primitiveName,m=(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(e.tintColor),p=void 0!==e.width?e.width:4,u=y(e.capStyle),g=h(e.joinStyle),d=e.miterLimit,[S,v]=D(i,c),N=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(e)+v).toString();n.push({type:"line",templateHash:N,materialHash:S?()=>s:s,cim:e,materialOverrides:null,isOutline:a,colorLocked:e.colorLocked,effects:e.effects,color:F(c,t,"TintColor",r,m,j),width:F(c,t,"Width",r,p),cap:F(c,t,"CapStyle",r,u),join:F(c,t,"JoinStyle",r,g),miterLimit:F(c,t,"MiterLimit",r,d),referenceWidth:l,zOrder:A(e.name),isDashed:!1})}function x(e,t,i,r,n,a,l){const s=e.primitiveName,c=void 0!==e.width?e.width:4,f=y(e.capStyle),m=h(e.joinStyle),p=e.miterLimit,[u,g]=D(i,s),d=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(e)+g).toString();n.push({type:"line",templateHash:d,materialHash:u?W(d,t,i,r):d,cim:e,materialOverrides:null,isOutline:a,colorLocked:e.colorLocked,effects:e.effects,color:{r:128,g:128,b:128,a:1},width:F(s,t,"Width",r,c),cap:F(s,t,"CapStyle",r,f),join:F(s,t,"JoinStyle",r,m),miterLimit:F(s,t,"MiterLimit",r,p),referenceWidth:l,zOrder:A(e.name),isDashed:!1})}function w(e,t,i,r,n){const a=e.markerPlacement;if(!a||"CIMMarkerPlacementInsidePolygon"!==a.type)return!1;const l=a,s=["Rotation","OffsetX","OffsetY"],c=i.filter((t=>t.primitiveName!==e.primitiveName&&-1===s.indexOf(t.propertyName))),[f,m]=D(i,l.primitiveName),p=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(e)+m).toString();return n.push({type:"fill",templateHash:p,materialHash:f?W(p,t,c,r):p,cim:e,materialOverrides:c,colorLocked:e.colorLocked,effects:e.effects,color:{r:255,g:255,b:255,a:1},height:F(l.primitiveName,t,"StepY",r,l.stepY),scaleX:1,angle:F(l.primitiveName,t,"GridAngle",r,l.gridAngle),offsetX:F(l.primitiveName,t,"OffsetX",r,l.offsetX),offsetY:F(l.primitiveName,t,"OffsetY",r,l.offsetY)}),!0}function z(e,t,i,r,n,a,l){const s=e.primitiveName,c=e.size,m=e.scaleX,p=e.rotation,u=e.offsetX,y=e.offsetY,h=(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(e.tintColor),g=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(`${e.url}${JSON.stringify(e.colorSubstitutions)}`).toString(),[d,S]=D(i,s),v=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(e)+S).toString();n.push({type:"marker",templateHash:v,materialHash:d?()=>g:g,cim:e,materialOverrides:null,colorLocked:e.colorLocked,effects:e.effects,scaleSymbolsProportionally:!1,alignment:a,size:F(s,t,"Size",r,c),scaleX:F(s,t,"ScaleX",r,m),rotation:F(s,t,"Rotation",r,p),offsetX:F(s,t,"OffsetX",r,u),offsetY:F(s,t,"OffsetY",r,y),color:F(s,t,"TintColor",r,h,j),anchorPoint:e.anchorPoint,isAbsoluteAnchorPoint:"Relative"!==e.anchorPointUnits,outlineColor:{r:0,g:0,b:0,a:0},outlineWidth:0,frameHeight:0,rotateClockwise:e.rotateClockwise,referenceSize:l,sizeRatio:1,markerPlacement:e.markerPlacement})}function J(e,t,i,o,r,n,a,l){const s=e.markerGraphics;if(!s)return;let c=0;if(e.scaleSymbolsProportionally){const t=e.frame;t&&(c=t.ymax-t.ymin)}for(const f of s)if(f){const s=f.symbol;if(!s)continue;switch(s.type){case"CIMPointSymbol":case"CIMLineSymbol":case"CIMPolygonSymbol":Y(e,f,i,t,o,r,n,a,c,l);break;case"CIMTextSymbol":H(e,f,t,i,o,r,n,a,c)}}}function H(e,t,i,r,n,s,c,p,u){const y=[];_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.OverrideHelper.findApplicableOverrides(t,r,y);const h=t.geometry;if(!("x"in h)||!("y"in h))return;const N=t.symbol,b=v(N),k=S(N.fontStyleName);N.font={family:N.fontFamilyName,decoration:b,...k};const O=e.frame,C=h.x-.5*(O.xmin+O.xmax),P=h.y-.5*(O.ymin+O.ymax),L=e.size/u,M=e.primitiveName,X=(N.height||0)*L,I=N.angle||0,x=((N.offsetX||0)+C)*L,w=((N.offsetY||0)+P)*L,z=(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getFillColor(N));let J=(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getStrokeColor(N)),H=_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getStrokeWidth(N);H||(J=(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getFillColor(N.haloSymbol)),H=N.haloSize*L);let Y="";for(const o of r)o.primitiveName===M&&void 0!==o.value&&(Y+=`-${o.primitiveName}-${o.propertyName}-${JSON.stringify(o.value)}`);const R=JSON.stringify(e.effects)+Number(e.colorLocked)+JSON.stringify(e.anchorPoint)+e.anchorPointUnits+JSON.stringify(e.markerPlacement),$=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(t)+R+Y).toString();s.push({type:"text",templateHash:$,materialHash:()=>(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(N.font)).toString(),cim:N,materialOverrides:null,colorLocked:e.colorLocked,effects:e.effects,alignment:c,anchorPoint:{x:e.anchorPoint?e.anchorPoint.x:0,y:e.anchorPoint?e.anchorPoint.y:0},isAbsoluteAnchorPoint:"Relative"!==e.anchorPointUnits,fontName:N.fontFamilyName,decoration:"none",weight:"normal",style:"normal",size:F(M,i,"Size",n,X),angle:F(M,i,"Rotation",n,I),offsetX:F(M,i,"OffsetX",n,x),offsetY:F(M,i,"OffsetY",n,w),horizontalAlignment:g(N.horizontalAlignment),verticalAlignment:d(N.verticalAlignment),text:F(t.primitiveName,i,"TextString",n,t.textString,_utils_js__WEBPACK_IMPORTED_MODULE_7__._adjustTextCase,N.textCase),color:z,outlineColor:J,outlineSize:H,referenceSize:p,sizeRatio:1,markerPlacement:e.markerPlacement})}function Y(e,t,i,r,n,l,m,p,u,y){const h=t.symbol,g=t.geometry;if(!g)return;const d=h.symbolLayers;if(!d)return;if(y)return void R(e,t,r,i,n,l,m,p,u);let S=d.length;for(;S--;){const y=d[S];if(y&&!1!==y.enable)switch(y.type){case"CIMSolidFill":case"CIMSolidStroke":{const h=(0,_SDFHelper_js__WEBPACK_IMPORTED_MODULE_6__.getExtent)(g);if(!h)continue;const[d,S,v]=(0,_SDFHelper_js__WEBPACK_IMPORTED_MODULE_6__.getSDFMetrics)(h,e.frame,e.size,e.anchorPoint,"Relative"!==e.anchorPointUnits),N="CIMSolidFill"===y.type,b={type:"sdf",geom:g,asFill:N},k=e.primitiveName,O=e.size,C=e.rotation||0,P=e.offsetX,L=e.offsetY,M=y.primitiveName,X=(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(N?_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getFillColor(y):_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getStrokeColor(y)),I=N?{r:0,g:0,b:0,a:0}:(0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.fromCIMColor)(_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getStrokeColor(y)),x=_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getStrokeWidth(y);if(!N&&!x)break;let w=!1,z="";for(const e of i)e.primitiveName!==M&&e.primitiveName!==k||(void 0!==e.value?z+=`-${e.primitiveName}-${e.propertyName}-${JSON.stringify(e.value)}`:e.valueExpressionInfo&&(w=!0));const J=JSON.stringify({...e,markerGraphics:null}),H=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(b)).toString(),Y={type:"marker",templateHash:(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(t)+JSON.stringify(y)+J+z).toString(),materialHash:w?()=>H:H,cim:b,materialOverrides:null,colorLocked:e.colorLocked,effects:e.effects,scaleSymbolsProportionally:e.scaleSymbolsProportionally,alignment:m,anchorPoint:{x:S,y:v},isAbsoluteAnchorPoint:!1,size:F(e.primitiveName,r,"Size",n,O),rotation:F(e.primitiveName,r,"Rotation",n,C),offsetX:F(e.primitiveName,r,"OffsetX",n,P),offsetY:F(e.primitiveName,r,"OffsetY",n,L),scaleX:1,frameHeight:u,rotateClockwise:e.rotateClockwise,referenceSize:p,sizeRatio:d,color:F(M,r,"Color",n,X,j),outlineColor:F(M,r,"Color",n,I,j),outlineWidth:F(M,r,"Width",n,x),markerPlacement:e.markerPlacement};l.push(Y);break}default:R(e,t,r,i,n,l,m,p,u)}}}function R(e,t,r,n,l,s,c,f,m){const p=$(e,t);let u=[];const y=["Rotation","OffsetX","OffsetY"];u=n.filter((t=>t.primitiveName!==e.primitiveName||-1===y.indexOf(t.propertyName)));let h="";for(const i of n)void 0!==i.value&&(h+=`-${i.primitiveName}-${i.propertyName}-${JSON.stringify(i.value)}`);const[g,d,S]=_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.CIMSymbolHelper.getTextureAnchor(p),v=e.primitiveName,N=e.rotation||0,b=e.offsetX||0,k=e.offsetY||0,O=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(JSON.stringify(p)+h).toString(),C={type:"marker",templateHash:O,materialHash:0===u.length?O:W(O,r,u,l),cim:p,materialOverrides:u,colorLocked:e.colorLocked,effects:e.effects,scaleSymbolsProportionally:e.scaleSymbolsProportionally,alignment:c,anchorPoint:{x:g,y:d},isAbsoluteAnchorPoint:!1,size:e.size,rotation:F(v,r,"Rotation",l,N),offsetX:F(v,r,"OffsetX",l,b),offsetY:F(v,r,"OffsetY",l,k),color:{r:0,g:0,b:0,a:0},outlineColor:{r:0,g:0,b:0,a:0},outlineWidth:0,scaleX:1,frameHeight:m,rotateClockwise:e.rotateClockwise,referenceSize:f,sizeRatio:S/(0,_core_screenUtils_js__WEBPACK_IMPORTED_MODULE_2__.pt2px)(e.size),markerPlacement:e.markerPlacement};s.push(C)}function $(e,t){return{type:e.type,enable:!0,name:e.name,colorLocked:e.colorLocked,primitiveName:e.primitiveName,anchorPoint:e.anchorPoint,anchorPointUnits:e.anchorPointUnits,offsetX:0,offsetY:0,rotateClockwise:e.rotateClockwise,rotation:0,size:e.size,billboardMode3D:e.billboardMode3D,depth3D:e.depth3D,frame:e.frame,markerGraphics:[t],scaleSymbolsProportionally:e.scaleSymbolsProportionally,respectFrame:e.respectFrame,clippingPath:e.clippingPath,effects:e.effects}}function A(e){if(e&&0===e.indexOf("Level_")){const t=parseInt(e.substr(6),10);if(NaN!==t)return t}return 0}function j(t){if(!t||0===t.length)return null;const i=new _Color_js__WEBPACK_IMPORTED_MODULE_0__.default(t).toRgba();return{r:i[0],g:i[1],b:i[2],a:i[3]}}function F(e,t,i,o,r,a,l){const s=t[e];if(s){const e=s[i];if("string"==typeof e||"number"==typeof e||e instanceof Array)return a?a.call(null,e,l):e;if(null!=e&&e instanceof _support_arcadeOnDemand_js__WEBPACK_IMPORTED_MODULE_4__.ArcadeExpression)return(t,i,n)=>{let s=(0,_views_2d_arcade_callExpressionWithFeature_js__WEBPACK_IMPORTED_MODULE_8__.default)(e,t,{$view:n},o.geometryType,i);return null!==s&&a&&(s=a.call(null,s,l)),null!==s?s:r}}return r}function W(e,t,i,r){for(const o of i){if(o.valueExpressionInfo){const e=t[o.primitiveName]&&t[o.primitiveName][o.propertyName];e instanceof _support_arcadeOnDemand_js__WEBPACK_IMPORTED_MODULE_4__.ArcadeExpression&&(o.fn=(t,i,o)=>(0,_views_2d_arcade_callExpressionWithFeature_js__WEBPACK_IMPORTED_MODULE_8__.default)(e,t,{$view:o},r.geometryType,i))}}return(t,r,n)=>{for(const e of i)e.fn&&(e.value=e.fn(t,r,n));return (0,_core_string_js__WEBPACK_IMPORTED_MODULE_3__.numericHash)(e+_CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.OverrideHelper.buildOverrideKey(i)).toString()}}function T(e,t){if(!t||0===t.length)return e;const i=JSON.parse(JSON.stringify(e));return _CIMSymbolHelper_js__WEBPACK_IMPORTED_MODULE_5__.OverrideHelper.applyOverrides(i,t),i}function D(e,t){let i=!1,o="";for(const r of e)r.primitiveName===t&&(void 0!==r.value?o+=`-${r.primitiveName}-${r.propertyName}-${JSON.stringify(r.value)}`:r.valueExpressionInfo&&(i=!0));return[i,o]}
