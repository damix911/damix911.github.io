"use strict";
(self["webpackChunkwind_es"] = self["webpackChunkwind_es"] || []).push([["node_modules_arcgis_core_views_2d_layers_SubtypeGroupLayerView2D_js"],{
...
*/
function o(e,r){return!e.visible||0!==e.minScale&&r>e.minScale||0!==e.maxScale&&r<e.maxScale}let l=class extends _FeatureLayerView2D_js__WEBPACK_IMPORTED_MODULE_8__.default{initialize(){this.handles.add([(0,_core_watchUtils_js__WEBPACK_IMPORTED_MODULE_2__.init)(this.view,"viewpoint",(()=>this._update()))])}_injectOverrides(e){const s=super._injectOverrides(e),t=this.view.scale,i=this.layer.sublayers.filter((e=>o(e,t))).map((e=>e.subtypeCode));if(!i.length)return s;const l=`NOT ${this.layer.subtypeField} IN (${i.join(",")})`;if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_1__.isNone)(s))return new _layers_support_FeatureFilter_js__WEBPACK_IMPORTED_MODULE_9__.default({where:l});const n=s.clone();return n.where+=` AND ${l}`,n}_setLayersForFeature(e){const r=this.layer.fieldsIndex.get(this.layer.subtypeField),s=e.attributes[r.name],t=this.layer.sublayers.find((e=>e.subtypeCode===s));e.layer=t,e.sourceLayer=this.layer}_createSchemaConfig(){const e={subtypeField:this.layer.subtypeField,sublayers:Array.from(this.layer.sublayers).map((e=>({featureReduction:null,geometryType:this.layer.geometryType,labelingInfo:e.labelingInfo,labelsVisible:e.labelsVisible,renderer:e.renderer,subtypeCode:e.subtypeCode})))},r=this.layer.sublayers.map((e=>e.subtypeCode)).join(","),s=this.layer.sublayers.length?`${this.layer.subtypeField} IN (${r})`:"1=2";let t=this.layer.definitionExpression?this.layer.definitionExpression+" AND ":"";return t+=s,{...super._createSchemaConfig(),...e,definitionExpression:t}}};l=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_7__.subclass)("esri.views.2d.layers.SubtypeGroupLayerView2D")],l);var n=l;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (n);
