"use strict";
(self["webpackChunkwind_es"] = self["webpackChunkwind_es"] || []).push([["vendors-node_modules_arcgis_core_layers_IntegratedMeshLayer_js"],{
...
/* harmony import */ var _multiOriginJSONSupportUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../multiOriginJSONSupportUtils.js */ "./node_modules/@arcgis/core/core/multiOriginJSONSupportUtils.js");
/* harmony import */ var _urlUtils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../urlUtils.js */ "./node_modules/@arcgis/core/core/urlUtils.js");
/* harmony import */ var _uuid_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../uuid.js */ "./node_modules/@arcgis/core/core/uuid.js");
/* harmony import */ var _metadata_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../metadata.js */ "./node_modules/@arcgis/core/core/accessorSupport/metadata.js");
/* harmony import */ var _PropertyOrigin_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../PropertyOrigin.js */ "./node_modules/@arcgis/core/core/accessorSupport/PropertyOrigin.js");
/* harmony import */ var _property_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./property.js */ "./node_modules/@arcgis/core/core/accessorSupport/decorators/property.js");
/* harmony import */ var _portal_support_resourceExtension_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../portal/support/resourceExtension.js */ "./node_modules/@arcgis/core/portal/support/resourceExtension.js");
...
*/
function g(r){const e=(0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)(r)&&r.origins?r.origins:[void 0];return(t,o)=>{const i=w(r,t,o);for(const r of e){const e=(0,_property_js__WEBPACK_IMPORTED_MODULE_6__.propertyJSONMeta)(t,r,o);for(const t in i)e[t]=i[t]}}}function w(r,e,o){if((0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)(r)&&"resource"===r.type)return v(r,e,o);switch((0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)(r)&&r.type?r.type:"other"){case"other":return{read:!0,write:!0};case"url":{const{read:t,write:r}=_chunks_persistableUrlUtils_js__WEBPACK_IMPORTED_MODULE_8__.p;return{read:t,write:r}}}}function v(e,s,u){const p=(0,_metadata_js__WEBPACK_IMPORTED_MODULE_4__.getOwnPropertyMetadata)(s,u);return{type:String,read:(t,r,e)=>{const o=(0,_chunks_persistableUrlUtils_js__WEBPACK_IMPORTED_MODULE_8__.r)(t,r,e);return p.type===String?o:"function"==typeof p.type?new p.type({url:o}):void 0},write:{writer(s,a,l,f){if(!f||!f.resources)return"string"==typeof s?void(a[l]=(0,_chunks_persistableUrlUtils_js__WEBPACK_IMPORTED_MODULE_8__.t)(s,f)):void(a[l]=s.write({},f));const m=P(s),d=m?(0,_chunks_persistableUrlUtils_js__WEBPACK_IMPORTED_MODULE_8__.t)(m,{...f,verifyItemRelativeUrls:f&&f.verifyItemRelativeUrls?{writtenUrls:f.verifyItemRelativeUrls.writtenUrls,rootPath:null}:null},1):null,g=p.type!==String&&(!(0,_multiOriginJSONSupportUtils_js__WEBPACK_IMPORTED_MODULE_1__.isMultiOriginJSONMixin)(this)||f&&f.origin&&this.originIdOf(u)>(0,_PropertyOrigin_js__WEBPACK_IMPORTED_MODULE_5__.nameToId)(f.origin));f&&f.portalItem&&(0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)(d)&&!(0,_urlUtils_js__WEBPACK_IMPORTED_MODULE_2__.isAbsolute)(d)?g?j(this,u,s,d,a,l,f,e):I(d,a,l,f):f&&f.portalItem&&((0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isNone)(d)||(0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isSome)((0,_chunks_persistableUrlUtils_js__WEBPACK_IMPORTED_MODULE_8__.i)(d))||(0,_urlUtils_js__WEBPACK_IMPORTED_MODULE_2__.isBlobProtocol)(d)||g)?U(this,u,s,d,a,l,f,e):a[l]=d}}}}function U(t,r,o,i,u,a,c,l){const m=(0,_uuid_js__WEBPACK_IMPORTED_MODULE_3__.generateUUID)(),y=S(o,i,c),h=(0,_urlUtils_js__WEBPACK_IMPORTED_MODULE_2__.join)((0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.get)(l,"prefix"),m),d=`${h}.${(0,_portal_support_resourceExtension_js__WEBPACK_IMPORTED_MODULE_7__.getResourceContentExtension)(y)}`,g=c.portalItem.resourceFromPath(d);(0,_urlUtils_js__WEBPACK_IMPORTED_MODULE_2__.isBlobProtocol)(i)&&c.resources.pendingOperations.push(b(i).then((t=>{g.path=`${h}.${(0,_portal_support_resourceExtension_js__WEBPACK_IMPORTED_MODULE_7__.getResourceContentExtension)(t)}`,u[a]=g.itemRelativeUrl})).catch((()=>{}))),O(t,r,g,y,c.resources.toAdd),u[a]=g.itemRelativeUrl}function j(t,r,e,o,i,n,s,p){const a=s.portalItem.resourceFromPath(o),c=S(e,o,s);(0,_portal_support_resourceExtension_js__WEBPACK_IMPORTED_MODULE_7__.getResourceContentExtension)(c)===(0,_urlUtils_js__WEBPACK_IMPORTED_MODULE_2__.getPathExtension)(a.path)?(O(t,r,a,c,s.resources.toUpdate),i[n]=o):U(t,r,e,o,i,n,s,p)}function I(t,r,e,o){o.resources.toKeep.push({resource:o.portalItem.resourceFromPath(t)}),r[e]=t}function O(t,r,e,o,i){i.push({resource:e,content:o,finish:e=>{R(t,r,e)}})}function S(t,r,e){return"string"==typeof t?{url:r}:new Blob([JSON.stringify(t.toJSON(e))],{type:"application/json"})}async function b(t){const r=(await Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ../../../request.js */ "./node_modules/@arcgis/core/request.js"))).default,{data:e}=await r(t,{responseType:"blob"});return e}function P(t){return (0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.isNone)(t)?null:"string"==typeof t?t:t.url}function R(t,r,e){"string"==typeof t[r]?t[r]=e.url:t[r].url=e.url}
...
/* harmony import */ var _core_accessorSupport_decorators_persistable_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../core/accessorSupport/decorators/persistable.js */ "./node_modules/@arcgis/core/core/accessorSupport/decorators/persistable.js");
...
/* harmony import */ var _support_I3SLayerDefinitions_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./support/I3SLayerDefinitions.js */ "./node_modules/@arcgis/core/layers/support/I3SLayerDefinitions.js");
/* harmony import */ var _support_SceneModifications_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./support/SceneModifications.js */ "./node_modules/@arcgis/core/layers/support/SceneModifications.js");
...
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
let O=class extends((0,_mixins_SceneService_js__WEBPACK_IMPORTED_MODULE_20__.SceneService)((0,_mixins_ArcGISService_js__WEBPACK_IMPORTED_MODULE_16__.ArcGISService)((0,_mixins_OperationalLayer_js__WEBPACK_IMPORTED_MODULE_17__.OperationalLayer)((0,_mixins_PortalLayer_js__WEBPACK_IMPORTED_MODULE_18__.PortalLayer)((0,_mixins_ScaleRangeLayer_js__WEBPACK_IMPORTED_MODULE_19__.ScaleRangeLayer)((0,_core_MultiOriginJSONSupport_js__WEBPACK_IMPORTED_MODULE_4__.MultiOriginJSONMixin)((0,_mixins_APIKeyMixin_js__WEBPACK_IMPORTED_MODULE_15__.APIKeyMixin)(_Layer_js__WEBPACK_IMPORTED_MODULE_14__.default)))))))){constructor(...e){super(...e),this.handles=new _core_Handles_js__WEBPACK_IMPORTED_MODULE_2__.default,this.geometryType="mesh",this.operationalLayerType="IntegratedMeshLayer",this.type="integrated-mesh",this.nodePages=null,this.materialDefinitions=null,this.textureSetDefinitions=null,this.geometryDefinitions=null,this.serviceUpdateTimeStamp=null,this.profile="mesh-pyramids",this.modifications=null,this._modificationsSource=null,this.elevationInfo=null,this.path=null}destroy(){this.handles.destroy()}initialize(){this.handles.add((0,_core_watchUtils_js__WEBPACK_IMPORTED_MODULE_6__.on)(this,"modifications","after-changes",(()=>this.modifications=this.modifications),null,null,!0))}normalizeCtorArgs(e,t){return"string"==typeof e?{url:e,...t}:e}readModifications(e,t,r){this._modificationsSource={url:(0,_chunks_persistableUrlUtils_js__WEBPACK_IMPORTED_MODULE_24__.f)(e,r),context:r}}async load(e){return this.addResolvingPromise(this._doLoad(e)),this}async _doLoad(e){const t=(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.get)(e,"signal");try{await this.loadFromPortal({supportedTypes:["Scene Service"]},e)}catch(r){(0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_5__.throwIfAbortError)(r)}if(await this._fetchService(t),(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isSome)(this._modificationsSource)){const t=await _support_SceneModifications_js__WEBPACK_IMPORTED_MODULE_23__.default.fromUrl(this._modificationsSource.url,this.spatialReference,e);this.setAtOrigin("modifications",t,this._modificationsSource.context.origin),this._modificationsSource=null}await this._fetchIndexAndUpdateExtent(this.nodePages,t)}beforeSave(){if(!(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(this._modificationsSource))return this.load().then((()=>{}),(()=>{}))}async saveAs(e,t){return this._debouncedSaveOperations(1,{...t,getTypeKeywords:()=>this._getTypeKeywords(),portalItemLayerType:"integrated-mesh"},e)}async save(){const e={getTypeKeywords:()=>this._getTypeKeywords(),portalItemLayerType:"integrated-mesh"};return this._debouncedSaveOperations(0,e)}validateLayer(e){if(e.layerType&&"IntegratedMesh"!==e.layerType)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__.default("integrated-mesh-layer:layer-type-not-supported","IntegratedMeshLayer does not support this layer type",{layerType:e.layerType});if(isNaN(this.version.major)||isNaN(this.version.minor))throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__.default("layer:service-version-not-supported","Service version is not supported.",{serviceVersion:this.version.versionString,supportedVersions:"1.x"});if(this.version.major>1)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__.default("layer:service-version-too-new","Service version is too new.",{serviceVersion:this.version.versionString,supportedVersions:"1.x"})}_getTypeKeywords(){return["IntegratedMeshLayer"]}};(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({type:String,readOnly:!0})],O.prototype,"geometryType",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({type:["show","hide"]})],O.prototype,"listMode",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({type:["IntegratedMeshLayer"]})],O.prototype,"operationalLayerType",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({json:{read:!1},readOnly:!0})],O.prototype,"type",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({type:_support_I3SLayerDefinitions_js__WEBPACK_IMPORTED_MODULE_22__.I3SNodePageDefinition,readOnly:!0})],O.prototype,"nodePages",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({type:[_support_I3SLayerDefinitions_js__WEBPACK_IMPORTED_MODULE_22__.I3SMaterialDefinition],readOnly:!0})],O.prototype,"materialDefinitions",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({type:[_support_I3SLayerDefinitions_js__WEBPACK_IMPORTED_MODULE_22__.I3STextureSetDefinition],readOnly:!0})],O.prototype,"textureSetDefinitions",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({type:[_support_I3SLayerDefinitions_js__WEBPACK_IMPORTED_MODULE_22__.I3SGeometryDefinition],readOnly:!0})],O.prototype,"geometryDefinitions",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({readOnly:!0})],O.prototype,"serviceUpdateTimeStamp",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({type:_support_SceneModifications_js__WEBPACK_IMPORTED_MODULE_23__.default}),(0,_core_accessorSupport_decorators_persistable_js__WEBPACK_IMPORTED_MODULE_13__.persistable)({origins:["web-scene","portal-item"],type:"resource",prefix:"modifications"})],O.prototype,"modifications",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_reader_js__WEBPACK_IMPORTED_MODULE_11__.reader)(["web-scene","portal-item"],"modifications")],O.prototype,"readModifications",null),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)(_support_commonProperties_js__WEBPACK_IMPORTED_MODULE_21__.elevationInfo)],O.prototype,"elevationInfo",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_7__.property)({type:String,json:{origins:{"web-scene":{read:!0,write:!0},"portal-item":{read:!0,write:!0}},read:!1}})],O.prototype,"path",void 0),O=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_12__.subclass)("esri.layers.IntegratedMeshLayer")],O);var M=O;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (M);
...
/* harmony import */ var _geometry_Polygon_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../geometry/Polygon.js */ "./node_modules/@arcgis/core/geometry/Polygon.js");
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
var l;let y=l=class extends _core_JSONSupport_js__WEBPACK_IMPORTED_MODULE_2__.JSONSupport{constructor(e){super(e),this.geometry=null,this.type="clip"}writeGeometry(e,r,o,s){if(s.layer&&s.layer.spatialReference&&!s.layer.spatialReference.equals(this.geometry.spatialReference)){if(!(0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_12__.canProjectWithoutEngine)(e.spatialReference,s.layer.spatialReference))return void(s&&s.messages&&s.messages.push(new _core_Warning_js__WEBPACK_IMPORTED_MODULE_4__.default("scenemodification:unsupported","Scene modifications with incompatible spatial references are not supported",{modification:this,spatialReference:s.layer.spatialReference,context:s})));const p=new _geometry_Polygon_js__WEBPACK_IMPORTED_MODULE_13__.default;(0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_12__.projectPolygon)(e,p,s.layer.spatialReference),r[o]=p.toJSON(s)}else r[o]=e.toJSON(s);delete r[o].spatialReference}clone(){return new l({geometry:(0,_core_lang_js__WEBPACK_IMPORTED_MODULE_3__.clone)(this.geometry),type:this.type})}};(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_5__.property)({type:_geometry_Polygon_js__WEBPACK_IMPORTED_MODULE_13__.default}),(0,_core_accessorSupport_decorators_persistable_js__WEBPACK_IMPORTED_MODULE_11__.persistable)()],y.prototype,"geometry",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_writer_js__WEBPACK_IMPORTED_MODULE_10__.writer)(["web-scene","portal-item"],"geometry")],y.prototype,"writeGeometry",null),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_5__.property)({type:["clip","mask","replace"],nonNullable:!0}),(0,_core_accessorSupport_decorators_persistable_js__WEBPACK_IMPORTED_MODULE_11__.persistable)()],y.prototype,"type",void 0),y=l=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_9__.subclass)("esri.layers.support.SceneModification")],y);var f=y;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (f);
...
/* harmony import */ var _SceneModification_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./SceneModification.js */ "./node_modules/@arcgis/core/layers/support/SceneModification.js");
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
var m;let n=m=class extends((0,_core_JSONSupport_js__WEBPACK_IMPORTED_MODULE_3__.JSONSupportMixin)(_core_Collection_js__WEBPACK_IMPORTED_MODULE_2__.default.ofType(_SceneModification_js__WEBPACK_IMPORTED_MODULE_11__.default))){constructor(r){super(r),this.url=null}toJSON(r){return this.toArray().map((o=>o.toJSON(r))).filter((r=>!!r.geometry))}clone(){return new m({url:this.url,items:this.items.map((r=>r.clone()))})}_readModifications(r,o){for(const e of r)this.add(_SceneModification_js__WEBPACK_IMPORTED_MODULE_11__.default.fromJSON(e,o))}static fromJSON(r,o){const e=new m;return e._readModifications(r,o),e}static async fromUrl(r,e,t){const c={url:(0,_core_urlUtils_js__WEBPACK_IMPORTED_MODULE_5__.urlToObject)(r),origin:"service"},p=await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__.default)(r,{responseType:"json",signal:(0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__.get)(t,"signal")}),n=e.toJSON(),f=[];for(const o of p.data)f.push(_SceneModification_js__WEBPACK_IMPORTED_MODULE_11__.default.fromJSON({...o,geometry:{...o.geometry,spatialReference:n}},c));return new m({url:r,items:f})}};(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_6__.property)({type:String})],n.prototype,"url",void 0),n=m=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_10__.subclass)("esri.layers.support.SceneModifications")],n);var f=n;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (f);
