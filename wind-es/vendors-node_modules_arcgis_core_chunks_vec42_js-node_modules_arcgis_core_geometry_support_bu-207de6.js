"use strict";
(self["webpackChunkwind_es"] = self["webpackChunkwind_es"] || []).push([["vendors-node_modules_arcgis_core_chunks_vec42_js-node_modules_arcgis_core_geometry_support_bu-207de6"],{
...
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
class s{constructor(t){this.allocator=t,this.items=[],this.itemsPtr=0,this.tickHandle=_nextTick_js__WEBPACK_IMPORTED_MODULE_1__.default.before((()=>this.reset())),this.grow()}destroy(){this.tickHandle&&(this.tickHandle.remove(),this.tickHandle=(0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.nullifyNonnullableForDispose)(this.tickHandle)),this.items=(0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.nullifyNonnullableForDispose)(this.items)}get(){return 0===this.itemsPtr&&(0,_nextTick_js__WEBPACK_IMPORTED_MODULE_1__.default)((()=>{})),this.itemsPtr===this.items.length&&this.grow(),this.items[this.itemsPtr++]}reset(){const t=Math.min(3*Math.max(8,this.itemsPtr),this.itemsPtr+3*e);this.items.length=Math.min(t,this.items.length),this.itemsPtr=0}grow(){for(let t=0;t<Math.max(8,Math.min(this.items.length,e));t++)this.items.push(this.allocator())}}const e=1024;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (s);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VectorStack": () => (/* binding */ a)
/* harmony export */ });
/* harmony import */ var _maybe_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./maybe.js */ "./node_modules/@arcgis/core/core/maybe.js");
/* harmony import */ var _nextTick_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./nextTick.js */ "./node_modules/@arcgis/core/core/nextTick.js");
...
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
class a{constructor(t,s,i){this.itemByteSize=t,this.itemCreate=s,this.buffers=[],this.items=[],this.itemsPerBuffer=0,this.itemsPtr=0,this.itemsPerBuffer=Math.ceil(i/this.itemByteSize),this.tickHandle=_nextTick_js__WEBPACK_IMPORTED_MODULE_1__.default.before((()=>this.reset()))}destroy(){this.tickHandle&&(this.tickHandle.remove(),this.tickHandle=(0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.nullifyNonnullableForDispose)(this.tickHandle)),this.itemsPtr=0,this.items=(0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.nullifyNonnullableForDispose)(this.items),this.buffers=(0,_maybe_js__WEBPACK_IMPORTED_MODULE_0__.nullifyNonnullableForDispose)(this.buffers)}get(){0===this.itemsPtr&&(0,_nextTick_js__WEBPACK_IMPORTED_MODULE_1__.default)((()=>{}));const t=Math.floor(this.itemsPtr/this.itemsPerBuffer);for(;this.buffers.length<=t;){const t=new ArrayBuffer(this.itemsPerBuffer*this.itemByteSize);for(let e=0;e<this.itemsPerBuffer;++e)this.items.push(this.itemCreate(t,e*this.itemByteSize));this.buffers.push(t)}return this.items[this.itemsPtr++]}reset(){const t=2*(Math.floor(this.itemsPtr/this.itemsPerBuffer)+1);for(;this.buffers.length>t;)this.buffers.pop(),this.items.length=this.buffers.length*this.itemsPerBuffer;this.itemsPtr=0}static createVec2f64(t=c){return new a(16,_chunks_vec2f64_js__WEBPACK_IMPORTED_MODULE_5__.c,t)}static createVec3f64(t=c){return new a(24,_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_6__.b,t)}static createVec4f64(t=c){return new a(32,_chunks_vec4f64_js__WEBPACK_IMPORTED_MODULE_7__.a,t)}static createMat3f64(t=c){return new a(72,_chunks_mat3f64_js__WEBPACK_IMPORTED_MODULE_2__.a,t)}static createMat4f64(t=c){return new a(128,_chunks_mat4f64_js__WEBPACK_IMPORTED_MODULE_3__.a,t)}static createQuatf64(t=c){return new a(32,_chunks_quatf64_js__WEBPACK_IMPORTED_MODULE_4__.c,t)}get test(){return{size:this.buffers.length*this.itemsPerBuffer*this.itemByteSize}}}const c=4096;
...
/* harmony export */   "isInteger": () => (/* binding */ u),
/* harmony export */   "isSigned": () => (/* binding */ r),
/* harmony export */   "maximumValue": () => (/* binding */ c)
/* harmony export */ });
...
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
function j(t){return t?{p0:(0,_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_3__.a)(t.p0),p1:(0,_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_3__.a)(t.p1),p2:(0,_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_3__.a)(t.p2)}:{p0:(0,_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_3__.c)(),p1:(0,_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_3__.c)(),p2:(0,_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_3__.c)()}}function h(t,n,r){const e=x.get();return e.p0=t,e.p1=n,e.p2=r,e}function k(t,n=j()){return d(t.p0,t.p1,t.p2,n)}function d(t,n,e,p=j()){return (0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.g)(p.p0,t),(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.g)(p.p1,n),(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.g)(p.p2,e),p}function v(t,n){const r=t.p0,s=t.p1,c=t.p2,u=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.f)(_vectorStacks_js__WEBPACK_IMPORTED_MODULE_5__.sv3d.get(),s,r),i=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.f)(_vectorStacks_js__WEBPACK_IMPORTED_MODULE_5__.sv3d.get(),c,s),f=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.f)(_vectorStacks_js__WEBPACK_IMPORTED_MODULE_5__.sv3d.get(),r,c),a=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.f)(_vectorStacks_js__WEBPACK_IMPORTED_MODULE_5__.sv3d.get(),n,r),j=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.f)(_vectorStacks_js__WEBPACK_IMPORTED_MODULE_5__.sv3d.get(),n,s),h=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.f)(_vectorStacks_js__WEBPACK_IMPORTED_MODULE_5__.sv3d.get(),n,c),k=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.c)(u,u,f),d=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.d)((0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.c)(_vectorStacks_js__WEBPACK_IMPORTED_MODULE_5__.sv3d.get(),u,k),a),v=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.d)((0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.c)(_vectorStacks_js__WEBPACK_IMPORTED_MODULE_5__.sv3d.get(),i,k),j),S=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.d)((0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.c)(_vectorStacks_js__WEBPACK_IMPORTED_MODULE_5__.sv3d.get(),f,k),h);if(d>0&&v>0&&S>0){const t=(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.d)(k,a);return t*t/(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.d)(k,k)}const b=(0,_lineSegment_js__WEBPACK_IMPORTED_MODULE_4__.distance2)((0,_lineSegment_js__WEBPACK_IMPORTED_MODULE_4__.fromValues)(r,u,q.get()),n),w=(0,_lineSegment_js__WEBPACK_IMPORTED_MODULE_4__.distance2)((0,_lineSegment_js__WEBPACK_IMPORTED_MODULE_4__.fromValues)(s,i,q.get()),n),M=(0,_lineSegment_js__WEBPACK_IMPORTED_MODULE_4__.distance2)((0,_lineSegment_js__WEBPACK_IMPORTED_MODULE_4__.fromValues)(c,f,q.get()),n);return Math.min(b,w,M)}function S(t,n,r){const e=1e-5,{direction:p,origin:o}=n,{p0:u,p1:i,p2:f}=t,a=i[0]-u[0],g=i[1]-u[1],m=i[2]-u[2],l=f[0]-u[0],j=f[1]-u[1],h=f[2]-u[2],k=p[1]*h-j*p[2],d=p[2]*l-h*p[0],v=p[0]*j-l*p[1],S=a*k+g*d+m*v;if(S>-e&&S<e)return!1;const b=1/S,w=o[0]-u[0],M=o[1]-u[1],q=o[2]-u[2],x=b*(w*k+M*d+q*v);if(x<0||x>1)return!1;const O=M*m-g*q,V=q*a-m*w,y=w*g-a*M,z=b*(p[0]*O+p[1]*V+p[2]*y);if(z<0||x+z>1)return!1;if(r){(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.a)(r,p,b*(l*O+j*V+h*y)),(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.b)(r,o,r)}return!0}function b(t,r,e){const p=(0,_chunks_vec2_js__WEBPACK_IMPORTED_MODULE_1__.d)(t,r),o=(0,_chunks_vec2_js__WEBPACK_IMPORTED_MODULE_1__.d)(r,e),s=(0,_chunks_vec2_js__WEBPACK_IMPORTED_MODULE_1__.d)(e,t),c=(p+o+s)/2,u=c*(c-p)*(c-o)*(c-s);return u<=0?0:Math.sqrt(u)}function w(t){return b(t.p0,t.p1,t.p2)}function M(t,n,r){return (0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.f)(O,n,t),(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.f)(V,r,t),(0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.l)((0,_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_2__.c)(O,O,V))/2}const q=new _core_ObjectStack_js__WEBPACK_IMPORTED_MODULE_0__.ObjectStack(_lineSegment_js__WEBPACK_IMPORTED_MODULE_4__.create),x=new _core_ObjectStack_js__WEBPACK_IMPORTED_MODULE_0__.ObjectStack((()=>({p0:null,p1:null,p2:null}))),O=(0,_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_3__.c)(),V=(0,_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_3__.c)();
...
See https://js.arcgis.com/4.21/esri/copyright.txt for details.
*/
class n{constructor(r){this.streamDataRequester=r}async loadJSON(r,e){return this.load("json",r,e)}async loadBinary(r,e){return (0,_core_urlUtils_js__WEBPACK_IMPORTED_MODULE_5__.isDataProtocol)(r)?((0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_4__.throwIfAborted)(e),(0,_core_urlUtils_js__WEBPACK_IMPORTED_MODULE_5__.dataToArrayBuffer)(r)):this.load("binary",r,e)}async loadImage(r,e){return this.load("image",r,e)}async load(t,i,m){if((0,_core_maybe_js__WEBPACK_IMPORTED_MODULE_3__.isNone)(this.streamDataRequester))return(await (0,_request_js__WEBPACK_IMPORTED_MODULE_0__.default)(i,{responseType:c[t]})).data;const n=await (0,_core_asyncUtils_js__WEBPACK_IMPORTED_MODULE_1__.result)(this.streamDataRequester.request(i,t,m));if(!0===n.ok)return n.value;throw (0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_4__.throwIfAbortError)(n.error),new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__.default("",`Request for resource failed: ${n.error}`)}}const c={image:"image",binary:"array-buffer",json:"json"};
